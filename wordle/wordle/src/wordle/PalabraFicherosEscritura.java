...
public class PalabraFicherosEscritura {
    ...
    //MÉTODOS
    //MÉTODO CONSTRUCTOR
    public PalabraFicherosEscritura(String nombreFichero) throws Exception {
    ...
    public void escrituraEspacio() throws Exception {
