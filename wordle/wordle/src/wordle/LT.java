package wordle; // canviau-ho pel vostre package <----
...
public class LT {
    ...
    //CORRESPONDENCIA CÓDIGO COLORES PARA TRAZADO Y FONDO
    ...
    /**    
     * 
     * @param letra letra que se quiere imprimir con X color
     * @param color color con el que se imprimirá la letra
     *     color = 0 -> Se imprime en verde
     *     color = 1 -> Se imprime en amarillo
     *     color = 2 -> Se imprime en verde 
     */
   
      public static void visualizacionLetras(char letra, int color){
        switch (color) {
            case 0:
            ...
            case 1: 
                ...
                break;
            case 2:
                System.out.print(ANSI_GREY + letra + ANSI_RESET);
                break;
        }
   }
